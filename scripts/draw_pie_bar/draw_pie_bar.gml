/// @description  draw_pie_bar(x ,y ,value, max, colour, radius, transparency)
/// @param x 
/// @param y 
/// @param value
/// @param  max
...
/// @param  radius
/// @param  transparency
function draw_pie_bar(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
