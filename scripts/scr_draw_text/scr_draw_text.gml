/// @function scr_draw_text(x,y,string,scale,color,angle,alpha,halign,valign,outlite,font)
function scr_draw_text(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10){
var t_x, t_y, t_string, t_scale, t_angle, t_alpha, t_halign, t_valign, t_outline, t_color, t_font;
    t_x = argument0;
    t_y = argument1;
    t_string = argument2;
    t_scale = argument3*global.text_scaling;
    t_color = argument4;
    t_angle = argument5;
    t_alpha = argument6;
    t_halign = argument7;
	...
	draw_set_alpha(t_alpha);
	    ...
	    if t_valign != -1 then draw_set_valign(t_valign);
	        if t_outline != -1{
	            ...
	            draw_text_transformed(t_x+1, t_y+1, string(t_string), t_scale, t_scale, t_angle);
	        }
