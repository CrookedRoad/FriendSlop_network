/// @description  draw_circular_bar_to_gui(x ,y ,value, max, colour, radius, transparency, width)
/// @param x 
/// @param y 
/// @param value
/// @param  max
...
/// @param  transparency
/// @param  width
function draw_circular_bar_to_gui(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7){
	if (argument2 > 0) { // no point even running if there is nothing to display (also stops /0
	    var i, len, tx, ty, val;
	    var _radius = argument5*global.gui_scaling;
	    var _width = argument7*global.gui_scaling;
	    ...
	    if (val > 1) { // HTML5 version doesnt like triangle with only 2 sides 
	        ...
	        draw_surface(piesurface,(argument0*global.gui_scaling)-_radius, (argument1*global.gui_scaling)-_radius)
